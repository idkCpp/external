...
if ALBERT_OP == "METADATA":
  ...
  elif QUERY.lower() == "conv help":
    result = "Expected format:"
    desc = "conv <amount> <from-unit> <to-unit>"
  else:
    result = "..."
  ...
  item = {
    ...
    "actions":[{
      ...
      "command":"sh",
      "arguments":["-c", "echo -n \"" + str(result) + "'\" | xclip -i; echo -n \"" + str(result) + "\" | xclip -i -selection clipboard;"]
    }]
  }
